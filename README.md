...
1. **Clone the Repository**
   ...
   - Run the following command to clone the GitHub repository:
     ```
     git clone https://github.com/kowsalyamahalingam28/Hand-Tracking-using-OpenCV.git
     ```
...
Hema Kalyan Murapaka - [@kowsalyamahalingam2004@gmail.com](kowsalyamahalingam2004@gmail.com)
